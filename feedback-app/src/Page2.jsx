    ...
    <div className="h-screen w-full bg-red-500 flex flex-col">
      ...
      <main className="flex-grow pt-24 px-4 text-center">
        <div className="text-white mb-6 slide-in">
          ...
          <img src="/SVGs/wallet.svg" alt="Cost" className="w-12 h-10 mr-0" />
          <h2 className="text-2xl font-semibold text-white">Cost</h2>
          </div>
        </div>

        <div className="bg-white shadow-lg rounded-lg p-6 max-w-md mx-auto slide-in">
          <div className="grid grid-cols-2">
            <button onClick={handleCostAwesomeClick} className="flex flex-col items-center p-4 transition-transform duration-150 ease-in-out transform hover:scale-110 active:scale-95">
              <img src="/Pics/Awesome.png" alt="Awesome" className="w-16 h-16" />
              <span className="mt-2 text-gray-700 font-medium">Awesome</span>
            </button>
            <button onClick={handleCostGoodClick} className="flex flex-col items-center p-4 transition-transform duration-150 ease-in-out transform hover:scale-110 active:scale-95">
              <img src="/Pics/Good.png" alt="Good" className="w-16 h-16" />
              <span className="mt-2 text-gray-700 font-medium">Good</span>
            </button>
            <button onClick={handleCostAverageClick} className="flex flex-col items-center p-4 transition-transform duration-150 ease-in-out transform hover:scale-110 active:scale-95">
              <img src="/Pics/Average.png" alt="Average" className="w-16 h-16" />
              <span className="mt-2 text-gray-700 font-medium">Average</span>
            </button>
            <button onClick={handleCostPoorClick} className="flex flex-col items-center p-4 transition-transform duration-150 ease-in-out transform hover:scale-110 active:scale-95">
              <img src="/Pics/Poor.png" alt="Poor" className="w-16 h-16" />
              <span className="mt-2 text-gray-700 font-medium">Poor</span>
            </button>
            <button onClick={handleCostWorstClick} className="flex flex-col items-center p-4 transition-transform duration-150 ease-in-out transform hover:scale-110 active:scale-95 col-span-2">
